...
const onClose = (tag) => {
  if (tag.active) {
    ...
    if (index === 0) {
      ...
      userStore.selectedKeys = tagStore.tagsList[1].selectedKeys
      userStore.openKeys = tagStore.tagsList[1].openKeys
      ...
      userStore.selectedKeys = tagStore.tagsList[index - 1].selectedKeys
      userStore.openKeys = tagStore.tagsList[index - 1].openKeys
      tagStore.clickTimeAdd()
